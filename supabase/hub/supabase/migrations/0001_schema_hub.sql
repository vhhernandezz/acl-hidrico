...
-- Migración 0001: esquema original (Sesión 0-B) — plantas, planta_status,
-- alarmas_activas, función de agregación.
-- Reconstruido para la Sesión 3-B porque nunca se había subido a GitHub
-- ni ejecutado en un proyecto Supabase real.
--
